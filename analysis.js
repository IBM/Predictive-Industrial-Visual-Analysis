            ...
            var promise = new Promise(function(resolve, reject) {
                                      db.get(cloudantDocument.args.id, null, function(error, response) {
                                             ...
                                             if (cloudantDocument.hasOwnProperty("_id") &&
                                                 cloudantDocument.type == "overwatch.image" &&
...
//
//    // read apihost, auth, and namespace from params
//    var apiHost = "openwhisk.ng.bluemix.net";
//    var namespace = "_";
//    var auth = "504fb2ee-df95-4fc9-9926-d15c015b25c3:iaFOqcPPKLkylHLdGTUYiLo1DXGv2egwzJG9l47LFvGvPlrstlJR8dJLGO2MyJMX";
//
//    // generate api_key from auth
//    var base64Auth = new Buffer(auth).toString('base64');
//    var apiKey = "Basic " + base64Auth;
...
//                      var fs = require('fs');
//                      fs.unlink(fileName);
//                      console.log("Finished processing faces, YAY!!");
//                      resolve(cloudantDocument);
//                  });
//              });
//              return promise;
//          };
//
//        return p0(cloudantDocument).then(p2).then(p3).then(p4).then(p5).then(p6).then(p7);
//
//      } else {
//        console.log("Cloudant update detected, ignoring");
//        return {done : true};
...
//function processFaces(document, fileName, db, analysis, processCallback) {
//    console.log("processing detected faces...");
//    console.log("VALUE OF DB IS: " + JSON.stringify(db));
//    var fs = require('fs');
//
//    if (analysis && analysis.hasOwnProperty("face_detection")) {
//        console.log("analysis has face_detection");
...
//            if (images[0].faces) {
//              facesToProcess = analysis.face_detection.images[0].faces;
//              console.log("VAR facestoProcess = " + facesToProcess);
//            }
//          }
//        }
//
...
//
//            if (err) {
//                console.log("Recieved error in callback area HERE!!");
//                processCallback( err );
//                console.log(err)
//            } else {
//                if (faceIndex < facesToProcess.length) {
...
//
//                        if (err) {
//                            console.log("Recieved error HERE within callback!");
//                            inProgressCallback(err);
//                        } else {
//
//                        //save to cloudant
...
//                            fs.readFile(faceImageName, function(readErr, data) {
//                            if (readErr) {
//                                console.log("Reached error during read file in faces to process!");
//                                inProgressCallback(err);
//                            } else {
//                                    console.log("DOCUMENT IS: " + JSON.stringify(latestDocument));
//                                    console.log("faceimagename IS: " + faceImageName);
//                                    //console.log("face Data i think is: " + data);
//                                    db.attachment.insert(latestDocument.id, faceImageName, data, 'image/jpg',
//                                {rev:latestDocument.rev}, function(saveErr, body) {
//                                        console.log("insert complete");
//                                        console.log("After insert complete, body is: " + body);
//                                        console.log("SAVE ERROR IS : " + saveErr);
//                                        latestDocument = body;
//
//                                        //remove thumb file after saved to cloudant
