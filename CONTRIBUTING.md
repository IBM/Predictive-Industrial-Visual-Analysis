...
repository](https://github.com/IBM/Integrate-Investment-Portfolio).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBM/Integrate-Investment-Portfolio/issues). Before embarking on
...
issue](https://github.com/IBM/Integrate-Investment-Portfolio/issues) before sending a pull
